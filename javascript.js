const i18n = {
  en: {
    ...
    try_sub: "not an full product yet. but the working example shows the core functionality we are building right now.",
    try_btn: "Prototype",
  ...
  ru: {
    ...
    try_sub: "Это ещё не полноценный продукт, но работающий пример показывает ключевую функциональность, которую мы сейчас создаём.",
    try_btn: "Прототип",
  ...
  uz: {
    ...
    try_sub: "Bu hali to‘liq tayyor mahsulot emas, lekin ishlayotgan namuna hozir qurayotgan asosiy funksionalligimizni ko‘rsatadi.",
